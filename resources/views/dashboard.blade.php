...
<head>
    ...
    <link href="{{ asset('css/bienvenidaDashBoard.css') }}" rel="stylesheet">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('index') }}" class="nav-item nav-link active"><i class="fa-solid fa-house me-2"></i>Inicio</a>

                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <i class="fa-solid fa-users me-2"></i>Reclutamiento</a>
                        <div class="dropdown-menu bg-transparent border-0">
        
                            <a href="{{ route('descriptorPuesto') }}" class="dropdown-item">Descriptor de puestos</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa-solid fa-list-check me-2"></i>Nomina</a>
                        <div class="dropdown-menu bg-transparent border-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="images/TheBurgerRockLogo.png" alt="" style="width: 40px; height: 40px;">
