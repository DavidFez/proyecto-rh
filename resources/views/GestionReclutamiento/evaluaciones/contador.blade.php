...
@section('contenido')
<div class="container">
    <h1 class="mb-4">Evaluación de Currículum Vitae - Contador (Caja)</h1>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="cargo" name="cargo" value="Contador (Caja)" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="formacion_academica" name="formacion_academica">
                            <option value="20">Contabilidad - 20 puntos</option>
                            <option value="15">Administración de Empresas - 15 puntos</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                        <label for="grado_tecnico" class="form-label">Grado Técnico</label>
                        <select class="form-select" id="grado_tecnico" name="grado_tecnico">
                            <option value="10">Técnico en Contabilidad - 10 puntos</option>
                            <option value="10">Técnico en Administración - 10 puntos</option>
                        </select>
                    </div>
                </div>
                <div class="row mb-3">
